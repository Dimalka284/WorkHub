                ...
                <div class="pb-6 mb-8 border-b border-gray-200">
                    ...
                    <div class="flex items-center mb-8 space-x-6">
                        ...
                        <div class="flex-grow">
                            ...
                            <input type="file" name="profilePic" id="profilePic" class="block w-full mt-1 text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-teal-50 file:text-blue-700 hover:file:bg-teal-100">
