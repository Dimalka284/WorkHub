...
<body class="min-h-screen bg-white">
    ...
    <header class="flex items-center justify-between p-6 border-b border-gray-100">
        ...
        <div class="flex items-center space-x-4 text-sm">
            ...
            <a href="/client_ac" class="font-medium text-blue-600 hover:text-blue-900">Join as a Client</a>
        </div>
    </header>
            ...
            <form class="space-y-6" action= {{route('freelancer.signup')}} method = "POST">
                ...
                <div class="space-y-1">
                    ...
                    <textarea
                        ...
                        class="block w-full px-3 py-2 mt-1 border border-gray-300 rounded-lg shadow-sm resize-y focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
                        maxlength="2000"
                        required
                    ></textarea>
